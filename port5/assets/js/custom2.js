...
$(window).scroll(function(){
  ...
  //슬라이드
  if(wScroll >= $(".introduce_box").offset().top -$(window).height()/1.4){
        $(".introduce_box").addClass("show2");
    }else {
        $(".introduce_box").removeClass("show2");
    }
  if(wScroll >= $(".mypoto").offset().top -$(window).height()/1.2){
        $(".mypoto").addClass("show2");
    }else {
        $(".mypoto").removeClass("show2");
    }
  if(wScroll >= $(".contact").offset().top -$(window).height()/1.3){
        $(".contact").addClass("show2");
    }else {
        $(".contact").removeClass("show2");
    }
});
